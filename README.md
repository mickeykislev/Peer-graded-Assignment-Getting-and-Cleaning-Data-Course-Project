...
4. summaries - calculated, along with units, and any other relevant information.
...
# 
# 
### The participant should create one R script called run_analysis.R that does the following.
